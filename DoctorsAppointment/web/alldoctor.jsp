...
<head><title>
    ...
    <link href="css/Alldoctor.css" rel="stylesheet" />
...
<body>
    ...
    <header id="header" class="header">
					...
					<div class="navbar-collapse collapse wow fadeInRight" data-wow-delay="0.9s">
						<ul class="nav navbar-nav navbar-right">
							...
							<li><a id="menu" href="contact.jsp"><span class="glyphicon glyphicon-earphone"></span> Contact</a></li>
                                                        <li class="current"><a id="menu" href="alldoctor.jsp"><span class="glyphicon glyphicon-th-list"></span> Doctor's List</a></li>
        ...
        <div class="container1">
           <input type="text" placeholder="Search" ng-model="searchText"><span id="searchicon" class="glyphicon glyphicon-search"></span></input>
		         <br><br>
             <div class="main">
